...
const Layout = ({ children }) => {
  ...
  const translations = {
    en: {
      ...
      footer: {
        description: "Empowering sales professionals with AI-driven pitch coaching and real-time feedback.",
        sections: {
          product: {
            title: "Product",
            links: [
    ...
    fr: {
      ...
      footer: {
        description: "Responsabiliser les professionnels de la vente avec un coaching de présentation alimenté par IA et des commentaires en temps réel.",
        sections: {
          product: {
            title: "Produit",
            links: [
  ...
  // Don't show layout header/footer for dashboard
  if (isDashboard) {
    return children;
  }
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <LanguageSwitcher />
              <Link to={user ? "/dashboard" : "/auth"} className="bg-primary-500 text-white px-6 py-2 rounded-lg hover:bg-primary-600 transition-colors">
            ...
            <div className="md:hidden flex items-center space-x-3">
              <LanguageSwitcher />
              <Link to={user ? "/dashboard" : "/auth"} className="bg-primary-500 text-white px-4 py-2 rounded-lg hover:bg-primary-600 transition-colors">
                {user ? "Dashboard" : t.nav.getStarted}
              </Link>
            </div>
          </div>
